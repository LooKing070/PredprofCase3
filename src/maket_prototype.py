...
class Ui_Soft(object):
    def setupUi(self, Soft, GameWindow, level_structure, sectors):
        ...
        self.saving_position = QtWidgets.QCheckBox(self.buttonsSorter)
        font = QtGui.QFont()
        font.setStyleStrategy(QtGui.QFont.PreferDefault)
        self.saving_position.setFont(font)
        self.saving_position.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.saving_position.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.saving_position.setAutoFillBackground(False)
        self.saving_position.setChecked(False)
        self.saving_position.setObjectName("checkBox")
        self.horizontalLayout_4.addWidget(self.saving_position, 0, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, Soft):
        ...
        self.saving_position.setText(_translate("Soft", "save position"))
